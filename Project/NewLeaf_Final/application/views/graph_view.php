...
<body>
	<div data-role="page" data-theme="a" id="see" class="wrapper" data-ajax=false>
	...
	<script type="text/javascript">
		//the graph will only show on page refresh.  I tried to force reload in serval different ways but none of them worked.
		$(function () {
			...
			for( var i = 0; i < dates.length; i++ ) {
		  	...
		  	var chart = r.g.linechart(
		    	250, 10,      // top left anchor
		    	800, 400,    // bottom right anchor
